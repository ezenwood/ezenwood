					...
					<div class="header_search_cont">
						<div class="h1_logo" style="cursor: pointer;"
							...
							<div id="logo_kor" style="display: block;">
								<a href="/ezenwood/main"> <img
									src="/ezenwood/resource/image/메인 로고.png"></a>
							</div>
					...
					<div class="gnb">
						...
						<div class="gnb_menu_box" style="z-index: 200">
							<ul class="depth0 gnb_menu0"
								...
								<li class="dropdown"><a href="javascript:void(0)"
									...
									<ul class="depth1, dropdown-content">
										<li style="width: 150px;"><a
											href="/ezenwood/goods/table/new/1">TABLE</a></li>
										<li style="width: 150px;"><a
											href="/ezenwood/goods/chair/new/1">CHAIR</a></li>
										<li style="width: 150px;"><a
											href="/ezenwood/goods/bed/new/1">BED</a></li>
										<li style="width: 150px;"><a
											href="/ezenwood/goods/sofa/new/1">SOFA</a></li>
										<li style="width: 150px;"><a
											href="/ezenwood/goods/chest/new/1">CHEST</a></li>
									</ul></li>
								<li class="dropdown"><a href="javascript:void(0)"
								...
								<li><a href="/ezenwood/about">ABOUT</a></li>
							</ul>
						</div>
						<!--상단 카테고리 출력 끝-->
					</div>
