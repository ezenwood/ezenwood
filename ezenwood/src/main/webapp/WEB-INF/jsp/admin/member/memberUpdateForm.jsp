					...
					<form method="post" enctype="multipart/form-data">
						<div class="form-group">
							<label>아이디</label> <input type="text" class="form-control"
								name="MEMBER_ID" value="${memberUpdateMap.MEMBER_ID }"
								style="width: 40%;" disabled>
						</div>

						<div class="form-group">
							<label>비밀번호</label> <input type="text" name="MEMBER_PW"
								class="form-control" value="${memberUpdateMap.MEMBER_PW }"
								style="width: 40%;">
						</div>
						<div class="form-group">
							<label>이름</label><input type="text" class="form-control"
								name="MEMBER_NAME" value="${memberUpdateMap.MEMBER_NAME }"
								style="width: 20%;">
						</div>
						...
						<div class="form-group">
							<tbody
								...
								<tr>
									<label>탈퇴여부</label>
									<br>
									<td><select option_product_no="#"
										option_select_element="option-select-finder"
										option_sort_no="1" option_type="T" item_listing_type="C"
										option_title="DESIGN" product_type="member_del_gb"
										product_option_area="#" name="MEMBER_DEL_GB" id="selectTag"
										class="ProductOption0" option_style="select" required="true">
						...
						<div class="form-group">
							<label>전화번호</label> <input type="text" class="form-control"
								name="MEMBER_PHONE" style="width: 40%;"
								placeholder="01011112222"
								value="${memberUpdateMap.MEMBER_PHONE }">
						</div>
						<div class="form-group">
							<label>이메일</label> <input type="text" class="form-control"
								name="MEMBER_EMAIL" style="width: 40%;"
								placeholder="aaa@aaa.com"
								value="${memberUpdateMap.MEMBER_EMAIL }">
						</div>
						<div class="form-group">
							<label>주소</label> <input type="text" id="sample4_postcode"
								name="MEMBER_ZIP" placeholder="우편번호"
								value="${memberUpdateMap.MEMBER_ZIP }"> <input
							...
							<input type="text" id="sample4_extraAddress" name="MEMBER_ADD3"
								placeholder="참고항목" value="${memberUpdateMap.MEMBER_ADD3}">
						</div>

						<button type="submit" class="btn btn-success">회원수정</button>
						<button class="btn btn-default"
							onclick="location.href='/ezenwood/admin/memberList/1'">작성취소</button>
					</form>
				</div>
			</div>
		</div>
