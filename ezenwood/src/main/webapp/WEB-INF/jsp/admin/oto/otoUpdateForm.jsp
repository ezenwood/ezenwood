...
<title>관리자 페이지 - 1:1 답변 수정</title>
</head>
<body>
<%@include file ="/include/admin_header.jsp" %>
<%@include file ="/include/admin_left.jsp" %>
		<div id="page-wrapper" style="min-height: 703px;">
		<form:form commandName="otoModel" action="#"
			enctype="multipart/form-data" method="post">
			<input type="hidden" name="no" value="${otoModel.no}" />
			<div id="page-wrapper">
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header">1:1 문의 답변 수정</h3>
						<table class="table table-striped table-bordered table-hover"
							...
							<thead>
								<tr class="danger">
									...
									<td colspan=3><input type="textarea" name="subject"
										value="${reviewModel.subject}" /> <font color="red"><form:errors
							...
							<tbody>
								<tr>
									<!-- 사용자 -->
									<th>사용자 ID</th>
									<td><strong> ${session_member_name } </strong></td>
								...
								<tr>
									...
									<td colspan=3><c:if
											test="${!empty reviewModel.imagefile_savname}">
											<img
												src="/pet/resources/reviewUpload/${reviewModel.imagefile_savname}"
												width="100" height="100" alt=""
												onerror="this.src='/pet/resources/images/noimg_130.gif'" />
											<input type="hidden" name="imagefile_savname"
								...
								<tr>
									...
									<td colspan=3><input type="file" name="file"
										value="${reviewModel.imagefile_savname}" /></td>
								</tr>
