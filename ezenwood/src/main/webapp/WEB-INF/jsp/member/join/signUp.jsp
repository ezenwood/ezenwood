        ...
        <div id="contents">
            <div class="location_wrap">
                <div class="location_cont">
                    <em>
                        <a href="#" class="local_home">HOME</a> > 회원가입
                    </em>
                </div>
            </div>
			...
			onclick="selectAll(this)" name="a">전체동의<br>
                                    </div>
                                </div>
                                <!--//join_agreement_box-->
                                <div class="join_agreement_box js_terms_view">
                                    ...
                                    <div class="agreement_box">
                                        ...
                                        표준약관 제10023호<br>
                                        <br>
                                        이 약관은 주식회사 효원재 회사(전자거래 사업자)가 운영하는 오가닉라이프 작은언니네가구점 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.<br>
                                        ※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는한 이 약관을 준용합니다」<br>
                                        <br>
                                        <br>
                                        제2조(정의)<br>
                                        <br>
                                        ① "몰"이란 주식회사 효원재 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br>
                                ...
                                <div class="join_agreement_box js_terms_view">
                                    <div class="form_element">
                                        <input type="checkbox" id="termsAgree2" name="a" class="require" value="n">
				...
				type="button" value="아이디 중복확인" onclick="idCheck()" style="font-size: 12px; line-height: 1.5; color: #333; margin: 0 0 0 5px; padding: 5px 10px 5px 10px; border: 1px solid #989898;"><form:errors path="memberDto.MEMBER_ID" />
                                               ...
                                               <td>
                                                   <div class="member_warning">
                                                       ...
                                                       <input type="button" onclick="test()" value="비밀번호 확인" style="font-size: 12px; line-height: 1.5; color: #333; margin: 0 0 0 5px; padding: 5px 10px 5px 10px; border: 1px solid #989898;">
                                                   </div>
                                               </td>
                                               </tr>
                                               <tr>
