...
<body>
	<div class="topbar">
		<span style="color: gray">HOME>회원가입</span>
	</div>
	<br>
	<br>
	<br>
	...
	<br>
	<div class="joinner">
		정보입력 > <span style="color: gray">가입 완료</span>
	</div>
	<br>
	<div class="ch">
		<h2>회원가입</h2>
		<p>약관 동의</p>
		<hr>
		<br> <br> <input type="checkbox" value="selectAll"
			onclick="selectAll(this)" name="a">전체동의<br> <input
			type="checkbox" name="a"> <span style="color: red">(필수)</span>
		이용 약관<br>
		<textarea name="ta1" rows="10" cols="70" wrap="virtual">
							제1조(목적)
표준약관 제10023호
이 약관은 주식회사 효원재 회사(전자거래 사업자)가 운영하는 오가닉라이프 작은언니네가구점 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는한 이 약관을 준용합니다
제2조(정의)
① "몰"이란 주식회사 효원재 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
1. 이 약관은 년 월 일부터 적용됩니다.						
		...
		<br> <input type="checkbox" name="a"> <span
			style="color: red">(필수)</span> 개인 정보 수집 및 이용<br>
		<textarea name="ta2" rows="10" cols="70" wrap="virtual">
