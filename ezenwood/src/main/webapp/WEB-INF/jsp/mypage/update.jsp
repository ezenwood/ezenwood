...
<div class="sub_menu_box">
    ...
    <ul class="sub_menu_mypage">
					<li>주문내역
            <ul class="sub_depth1">
                <li><a href="./mypage/order.jsp">- 주문목록/배송조회</a></li>
                <li><a href="./mypage/cancel.jsp">- 취소 내역</a></li>         
            </ul>
        </li> 	
        <li>게시글 관리
            <ul class="sub_depth1">
                <li><a href="./mypage/review.jsp">리뷰 관리</a></li>
                <li><a href="./mypage/oto.jsp">- 1:1 문의</a></li>
                <li><a href="./mypage/qna.jsp">- Q&A</a></li>
            </ul>
        </li>
        <li>회원정보
            <ul class="sub_depth1">
                <li><a href="./mypage/update.jsp">- 회원정보 변경/탈퇴</a></li>
            </ul>
        </li>
				</ul>
</div>
    ...
    <div class="mypage_cont">
      ...
      <div class="location_wrap1">
                <div class="location_cont1">
                    <em><a href="#" class="local_home1" style="font-weight: bold">정보입력</a>&gt;가입완료</em>
                </div>
            </div>
            <!-- //location_wrap -->
     <!-- 회원가입/정보 기본정보 -->
    ...
    <div class="base_info_sec">
        <table border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td>
                     <div class="member_warning">
                        <input type="password" name="memCurrentPw" maxlength="30" placeholder="현재 비밀번호를 입력하세요."> 
                     </div>   
                </td>
            </tr>
              <tr>
               ...
               <tr>
                ...
                <td>
                       <div class="member_warning">
                            <input type="password" name="newPwCheck" maxlength="30" placeholder="새로운 비밀번호를 입력하세요.">
                       </div>
                </td>
            </tr>  
            </div>        
            ...
            <tr>
                ...
                <td>
                       <div class="member_warning">
                            <input type="text" name="memNm" value="${member_name}" maxlength="30" placeholder="이름을 입력하세요.">
                       </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="member_address">
                    <div class="address_postcode">
                       ...
                       <div class="add">
                          <input type="text" id="sample4_roadAddress" placeholder="도로명 주소">
                            <input type="text" id="sample4_jibunAddress" placeholder="지번 주소">  
                             <span id="guide" style="color: #999; display: none"></span>
                       </div>
                    <div class="add">
                            <input type="text" id="sample4_detailAddress" placeholder="상세 주소">
