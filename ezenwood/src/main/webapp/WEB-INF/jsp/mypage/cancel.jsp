		...
		<div id="contents">
			...
			<div class="location_wrap">
				<div class="location_cont">
					<em> <a href="/ezenwood/mypage/main" class="local_home">Home</a> &gt;취소 내역
					</em>
				</div>
			</div>
			<!-- locaion_wrap-->
				...
				<div class="content">
					...
					<div class="mypage_lately_info_cont">
						...
						<span class="pick_list_num" style="text-align: center">
							취소/반품/교환 내역 총 <strong>0</strong> 건
						</span>
						<!-- 주문상품 리스트-->
						...
						<!--사유 레이어-->
						<div id="lyReason" class="layer_wrap reson_layer dn"
							data-remote="./mypage/cancel.jsp"></div>
