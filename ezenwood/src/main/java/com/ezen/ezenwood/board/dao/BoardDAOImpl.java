...
public class BoardDAOImpl extends AbstractDAO implements BoardDAO{
	...
	@Override
	public Map<String, Object> InsertOTOGET(Map<String, Object> insertMap) {
		
	return (Map<String, Object>) selectOne("onetoone.insertOTOGET", insertMap);
	}
	...
	public Map<String, Object> OTODelete(Map<String, Object> insertMap) {
		// TODO Auto-generated method stub
		return (Map<String, Object>) selectOne("onetoone.deletetOTO", insertMap);		
